...
CAP_REMOVE_SOMETHING_LIST_CONFIG = {
    ...
    { "remove_saya_qh_platform", "魔女的魔法炼药台", "让魔女魔法炼药台消失！", disappear_magic, 150 },--考虑到本来就存在的炼药指定季节满分，所以设置的时间和标准时间不太一致
    { "remove_saya_potions_attack ", "魔女的进攻魔药", "让魔女的百分比伤害的魔药消失！", disappear_magic, 140 },
