...
CAP_REMOVE_SOMETHING_LIST_CONFIG = {
    ...
    { "remove_itemmimic_revealed", "拟态蠕虫", "限制拟态蠕虫可用的时间！", disappear_magic, 0 },
    { "remove_myth_qxj", "神话的七星剑", "让神话的七星剑消失！", disappear_magic, -1 },
    { "remove_myth_bigpeach", "神话的大蟠桃", "让神话的大蟠桃消失！", disappear_magic, 0 },
    { "remove_myth_mooncake", "神话的三种月饼", "让神话的三种月饼消失！", disappear_magic, 0 },
    ...
    { "remove_saya_potions_grow", "魔女的成长魔药", "让魔女突破等级上限的魔药消失！", disappear_magic, 0 },
    { "remove_saya_potions_wonderful", "魔女的奇妙魔药", "让魔女藏宝图霸体魔药消失！", disappear_magic, 0 },
    { "remove_saya_potions_eternal", "魔女的永恒魔药", "让魔女可多次使用的魔药消失！", disappear_magic, 0 },
