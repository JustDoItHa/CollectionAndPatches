...
local function Text_K(inst)
	...
	label:SetFontSize((DaXiao - 10))
	label:SetWorldOffset(0,(Yzhou + 1), 0)
...
local function Text_A(inst)
	...
	inst._labei:SetFont(BODYTEXTFONT)
	inst._labei:SetFontSize((DaXiao - 10))
	inst._labei:SetWorldOffset(0,(Yzhou + 1), 0)
	--inst._labei:SetWorldOffset(0,4, 0)
