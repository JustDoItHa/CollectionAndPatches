...
local function inventoryitem()
    ...
    inst.components.container.onopenfn = function(inst)
        ...
        if inst.components.inventoryitem then
            inst.components.inventoryitem.atlasname = "images/inventoryimages/huge_box/open.xml"
    ...
    inst.components.container.onclosefn = function(inst)
        ...
        if inst.components.inventoryitem then
            inst.components.inventoryitem.atlasname = "images/inventoryimages/huge_box/close.xml"
