...
local assets =
{
    Asset("ANIM", "anim/baka_lamp_post.zip"),
...
local function fn()
    ...
    inst.AnimState:SetBuild("baka_lamp_post")
    inst.Light:SetRadius(14)
...
return Prefab("baka_lamp_post", fn, assets, prefabs),
    MakePlacer("baka_lamp_post_placer", "baka_lamp_post", "baka_lamp_post", "idle_off")