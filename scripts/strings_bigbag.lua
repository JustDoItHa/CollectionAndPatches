...
if TUNING.ROOMCAR_BIGBAG_LANG == 1 then
	...
	STRINGS.NAMES.REDBIGBAG                                  = "保暖大背包"
	STRINGS.NAMES.BLUEBIGBAG                                 = "防热大背包"
    STRINGS.RECIPE_DESC.BIGBAG                               = "一个好大好大的背包！"
	STRINGS.RECIPE_DESC.REDBIGBAG                               = "一个好大且可以保暖的背包！"
	STRINGS.RECIPE_DESC.BLUEBIGBAG                               = "一个好大且可以防热的背包！"
    ...
    STRINGS.NAMES.CATBIGBAG = "猫咪"
    STRINGS.CHARACTERS.GENERIC.DESCRIBE.CATBIGBAG = "可爱捏"
    STRINGS.RECIPE_DESC.CATBIGBAG = "领养一只猫咪"

    STRINGS.NAMES.CATBACK = "小猫包"
    STRINGS.CHARACTERS.GENERIC.DESCRIBE.CATBACK = "可爱的小猫包捏"
    STRINGS.RECIPE_DESC.CATBACK = "一个可爱的笑猫包"
	...
	STRINGS.NAMES.REDBIGBAG                                  = "Warm Big Bag"
	STRINGS.NAMES.BLUEBIGBAG                                 = "Cold Big Bag"
	STRINGS.RECIPE_DESC.REDBIGBAG                               = "Very powerful!"
	STRINGS.RECIPE_DESC.BLUEBIGBAG                               = "Wonderful bag!"
    ...
    STRINGS.NAMES.CATBIGBAG = "cat~~"
    STRINGS.CHARACTERS.GENERIC.DESCRIBE.CATBIGBAG = "cute!"
    STRINGS.RECIPE_DESC.CATBIGBAG = "get a cute cat~"
end