...
local function IsSideWidget(prefab)
    ...
    if params.widget ~= nil then
        return params.widget.issidewidget
    else
        print("params.widget not exist.")
    end
end
...
local function PageUpgrade(inst, data, params)
    local chestupgrade = inst.components.chestupgrade
    local x, y, z = chestupgrade:GetLv()
