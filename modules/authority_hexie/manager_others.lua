...
if IsServer then
    ...
    AddComponentPostInit("explosive", function(explosive, inst)
        ...
        function explosive:OnBurnt()
            ...
            if nearbyStructure then
                --Make sure structures aren't lit on fire (indirectly) from explosives
    ...
    local function SpawnerMinotaurFn(inst)
        if inst.guard_authorization.minotaur.isSpawnPrefab then
            ...
            if setPos ~= nil and setPos.x ~= nil and setPos.y ~= nil and setPos.z ~= nil then
