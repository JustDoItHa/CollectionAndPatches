...
TUNING.QIHUANJIANGLIN_ENABLE = modenable({ "2867435690", "2790273347", "奇幻降临：永恒终焉", "永恒终焉" }) or modenable({ "2898657309", "2958351483", "奇幻降临：第四人称", "第四人称" }) or modenable({ "2965155245", "第四人称：主线重载", "第四人称" }) or modenable({ "3288693628" })
...
TUNING.SIMPLE_ECONOMY_FOR_RX = modenable({ "2846621983", "简单经济学(改专用)" }) or modenable({ "3534249670", "简单经济学(改专用)" })
